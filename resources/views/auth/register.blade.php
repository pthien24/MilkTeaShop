...
<section class="form-container">
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            <input id="address" type="text" placeholder="enter your address" class="box form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" required autocomplete="address" autofocus>
            @error('address')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div>
            <input id="phone" type="number" min="0" max="9999999999" placeholder="enter your phone" class="box form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="phone">
            @error('phone')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div>
        <input id="password-confirm" required maxlength="20" type="password" class="box form-control" placeholder="confirm your password" name="password_confirmation" required autocomplete="new-password">
        </div>
